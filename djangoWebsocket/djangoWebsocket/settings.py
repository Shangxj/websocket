# coding=utf-8
"""
Django settings for djangoWebsocket project.
...
SECRET_KEY = '&(nq$-e=w7+)9^6649vcuaw1lxci0)+&u=hu*)^42f+@h-$b6g'

# django admin 账号密码：admin/*123456*
...
ROOT_URLCONF = 'djangoWebsocket.urls'
